...
import {
    ArrowLeft, Cpu, Zap, CheckCircle2,
    MessageSquare, Bot, Sparkles, Brain,
    Layers, Search, Terminal, ArrowRight, ShieldCheck, Target
} from 'lucide-react';
import Link from 'next/link';

export default function AISalesBrain() {
    return (
        <div className="pt-32 pb-40 space-y-40 overflow-hidden">
                ...
                <div className="grid grid-cols-1 lg:grid-cols-2 gap-20 items-center">
                    <div className="space-y-12">
                        ...
                        <p className="text-2xl font-medium text-slate-500 leading-relaxed max-w-xl">
                            Deploy LLM-powered intelligence to your front-line communication. Move beyond static bots to systems that understand intent and nuance.
                        </p>
                    </div>
                    ...
                    <div className="relative group">
                        ...
                        <div className="relative glass bg-white p-12 rounded-[4rem] border border-slate-100 shadow-2xl space-y-12">
                            <div className="grid grid-cols-2 gap-8">
                                {[
                                    { icon: Sparkles, label: "GPT-4o", sub: "Model" },
                                    { icon: Bot, label: "90%+", sub: "Accuracy" },
                                    { icon: Search, label: "Intent", sub: "Mapping" },
                                    { icon: ShieldCheck, label: "Private", sub: "Data" }
                                ].map((stat, i) => (
                            ...
                            <div className="pt-8 border-t border-slate-50">
                                <h3 className="text-sm font-black text-slate-900 uppercase tracking-widest mb-6">Cognitive Stack</h3>
                                <div className="flex flex-wrap gap-3">
                                    {["OpenAI API", "Claude 3.5", "Pinecone", "LangChain"].map((tech, i) => (
            ...
            <section className="bg-slate-50/50 py-40 border-y border-slate-100 relative">
                <div className="max-w-7xl mx-auto px-6">
                    <div className="text-center max-w-2xl mx-auto mb-24 space-y-4">
                        <h2 className="text-5xl font-black text-slate-900 tracking-tight leading-tight">Intelligence Flow</h2>
                        <p className="text-slate-500 text-xl font-medium">From raw text to high-fidelity sales intelligence.</p>
                    </div>
                        ...
                        {[
                            {
                                step: "01",
                                title: "Ingestion",
                                desc: "The brain listens to incoming WhatsApps, Emails, and Form submissions in real-time.",
                                icon: MessageSquare
                            },
                            {
                                step: "02",
                                title: "Intent Mapping",
                                desc: "Our LLM layer classifies the lead based on urgency, budget, and specific service needs.",
                                icon: Target
                            },
                            {
                                step: "03",
                                title: "Draft Generation",
                                desc: "A personalized, human-sounding draft is created and pushed to your team for approval.",
                                icon: Terminal
                            }
                        ].map((item, i) => (
            ...
            <section className="max-w-7xl mx-auto px-6">
                <div className="grid grid-cols-1 lg:grid-cols-2 gap-32 items-center">
                    <div className="space-y-12">
                        <h2 className="text-5xl font-black text-slate-900 tracking-tight leading-tight text-center md:text-left">Machine Intelligence <br />Sales ROI.</h2>
                        <div className="grid grid-cols-1 sm:grid-cols-2 gap-8">
                            {[
                                { title: "24/7 Qualification", desc: "Leads are graded the moment they arrive, even at 3 AM." },
                                { title: "Custom Personality", desc: "The AI adopts your brand's unique tone and technical vocabulary." },
                                { title: "No Lead Left Behind", desc: "Scale your response capacity without increasing headcount." },
                                { title: "Sales Prioritization", desc: "Your team focuses only on 'A-Grade' qualified intent." }
                            ].map((val, i) => (
                    ...
                    <div className="relative glass bg-slate-950 rounded-[4rem] p-12 md:p-20 border-slate-900 shadow-2xl overflow-hidden group">
                        ...
                        <div className="space-y-10 relative z-10">
                            <p className="text-4xl font-black text-white leading-tight tracking-tighter">
                                "Smart systems don't just work harder; they work with judgment."
                            </p>
                            ...
                            <div className="flex items-center space-x-4">
                                ...
                                <div>
                                    <p className="text-sm font-black text-white uppercase tracking-widest">Cognitive Core</p>
                                    <p className="text-xs font-bold text-slate-500 uppercase tracking-[0.2em]">Sales Brain Layer</p>
                                </div>
                            </div>
                        </div>
                    </div>
                ...
                >
                    ...
                    <div className="max-w-3xl mx-auto space-y-12 relative z-10">
                        <h2 className="text-5xl md:text-7xl font-black tracking-tight leading-tight">
                            Activate Your <br />AI Sales Agent.
                        </h2>
                        <div className="flex flex-col items-center space-y-8">
                            ...
                            <p className="text-blue-100 font-bold uppercase tracking-[0.3em] text-xs">LLM Integration Required</p>
                        </div>
                    </div>
                </motion.div>
            </section>
