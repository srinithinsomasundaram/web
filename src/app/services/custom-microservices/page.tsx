...
import {
    ArrowLeft, Terminal, Zap, CheckCircle2,
    Code2, Cpu, Globe, Wrench,
    Layers, Search, Settings, ArrowRight, ShieldCheck, Box
} from 'lucide-react';
import Link from 'next/link';

export default function CustomMicroservices() {
    return (
        <div className="pt-32 pb-40 space-y-40 overflow-hidden">
                ...
                <div className="grid grid-cols-1 lg:grid-cols-2 gap-20 items-center">
                    <div className="space-y-12">
                        ...
                        <p className="text-2xl font-medium text-slate-500 leading-relaxed max-w-xl">
                            When off-the-shelf tools fail, we build lightweight, high-performance microservices to bridge the gap and solve unique logic puzzles.
                        </p>
                    </div>
                    ...
                    <div className="relative group">
                        ...
                        <div className="relative glass bg-white p-12 rounded-[4rem] border border-slate-100 shadow-2xl space-y-12">
                            <div className="grid grid-cols-2 gap-8">
                                {[
                                    { icon: Code2, label: "Node.js", sub: "Core" },
                                    { icon: Globe, label: "REST", sub: "Protocols" },
                                    { icon: Cpu, label: "Vercel", sub: "Edge" },
                                    { icon: ShieldCheck, label: "Private", sub: "Proxy" }
                                ].map((stat, i) => (
                            ...
                            <div className="pt-8 border-t border-slate-50">
                                <h3 className="text-sm font-black text-slate-900 uppercase tracking-widest mb-6">Backend Stack</h3>
                                <div className="flex flex-wrap gap-3">
                                    {["Node.js", "Python", "Auth0", "AWS Lambda"].map((tech, i) => (
            ...
            <section className="bg-slate-50/50 py-40 border-y border-slate-100 relative">
                <div className="max-w-7xl mx-auto px-6">
                    <div className="text-center max-w-2xl mx-auto mb-24 space-y-4">
                        <h2 className="text-5xl font-black text-slate-900 tracking-tight leading-tight">Engineering Flow</h2>
                        <p className="text-slate-500 text-xl font-medium">Bespoke development for non-standard business logic.</p>
                    </div>
                        ...
                        {[
                            {
                                step: "01",
                                title: "Logic Audit",
                                desc: "We map out the exact technical barrier that standard automation tools can't overcome.",
                                icon: Search
                            },
                            {
                                step: "02",
                                title: "Edge Build",
                                desc: "We deploy a custom API or logic controller on serverless infrastructure for maximum speed.",
                                icon: Settings
                            },
                            {
                                step: "03",
                                title: "Handshake",
                                desc: "The microservice is integrated back into your main workflow as a seamless 'black box' utility.",
                                icon: ArrowRight
                            }
                        ].map((item, i) => (
            ...
            <section className="max-w-7xl mx-auto px-6">
                <div className="grid grid-cols-1 lg:grid-cols-2 gap-32 items-center">
                    <div className="space-y-12">
                        <h2 className="text-5xl font-black text-slate-900 tracking-tight leading-tight text-center md:text-left">Code-Level <br />Solutions.</h2>
                        <div className="grid grid-cols-1 sm:grid-cols-2 gap-8">
                            {[
                                { title: "API Bridging", desc: "Connect tools that don't have native integrations or Zapier support." },
                                { title: "Custom Formatting", desc: "Sophisticated data transformation that 'no-code' can't handle." },
                                { title: "Private Proxies", desc: "Securely tunnel data between internal systems and the web." },
                                { title: "Ownership", desc: "You own the lightweight code that runs your most vital transitions." }
                            ].map((val, i) => (
                    ...
                    <div className="relative glass bg-slate-950 rounded-[4rem] p-12 md:p-20 border-slate-900 shadow-2xl overflow-hidden group">
                        ...
                        <div className="space-y-10 relative z-10">
                            <p className="text-4xl font-black text-white leading-tight tracking-tighter">
                                "If you can define the logic, we can write the engine."
                            </p>
                            ...
                            <div className="flex items-center space-x-4">
                                ...
                                <div>
                                    <p className="text-sm font-black text-white uppercase tracking-widest">Engineering Core</p>
                                    <p className="text-xs font-bold text-slate-500 uppercase tracking-[0.2em]">Service Layer</p>
                                </div>
                            </div>
                        </div>
                    </div>
                ...
                >
                    ...
                    <div className="max-w-3xl mx-auto space-y-12 relative z-10">
                        <h2 className="text-5xl md:text-7xl font-black tracking-tight leading-tight">
                            Build Your Custom <br />Logic Hub.
                        </h2>
                        <div className="flex flex-col items-center space-y-8">
                            ...
                            <p className="text-blue-100 font-bold uppercase tracking-[0.3em] text-xs">Technical Scoping Required</p>
                        </div>
                    </div>
                </motion.div>
            </section>
